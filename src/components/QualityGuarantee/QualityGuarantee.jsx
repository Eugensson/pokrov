    ...
    <section className={styles.wrapper}>
        <div className={styles.descriptions}>
          <h2 className={styles.subtitle}>Гарантія якості</h2>
            <p className={styles.text}>Ми забезпечуємо надійність наших виробів протягом 50 років завдяки високоякісному покриттю їх нітридом титану, що захищає від атмосферних факторів, включаючи агресивні та промислові умови.
