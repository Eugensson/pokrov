      ...
      <div className="my-4 stats inline-grid md:flex shadow stats-vertical md:stats-horizontal">
        <div className="stat">
          ...
          <div className="stat-desc">
            <Link href="/admin/orders">Переглянути продажі</Link>
          </div>
        </div>
        <div className="stat">
          <div className="stat-title">Замовлення</div>
          <div className="stat-value text-primary">{summary.ordersCount}</div>
          <div className="stat-desc">
            <Link href="/admin/orders">Переглянути замовлення</Link>
          </div>
        </div>
        <div className="stat">
          <div className="stat-title">Продукція</div>
          <div className="stat-value text-primary">{summary.productsCount}</div>
          <div className="stat-desc">
            <Link href="/admin/products">Переглянути продукцію</Link>
          </div>
        </div>
        <div className="stat">
          ...
          <div className="stat-desc">
            <Link href="/admin/users">Переглянути користовучів</Link>
          </div>
        </div>
      </div>
