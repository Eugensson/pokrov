...
import { SalesReport } from "@/app/(admin)/overview/sales-report";
import { UsersReport } from "@/app/(admin)/overview/users-report";
import { OrdersReport } from "@/app/(admin)/overview/orders-report";
import { ProductsReport } from "@/app/(admin)/overview/products-report";
...
export const OverviewData = () => {
  ...
  const { data: summary, error } = useSWR(`/api/admin/overview`);
